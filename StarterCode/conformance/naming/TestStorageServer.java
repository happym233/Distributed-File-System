...
class TestStorageServer implements Storage, Command
{
     ...
     */
    TestStorageServer(Test test, Integer i)
    {
        this.test = test;
        client_skeleton = new StorageSkeleton(i);
        command_skeleton = new CommandSkeleton(i);
    ...
    private class StorageSkeleton extends Skeleton<Storage>
    {
        ...
        StorageSkeleton(Integer i)
        {
            super(Storage.class, TestStorageServer.this, new InetSocketAddress(8020+2*i));
        }
    ...
    private class CommandSkeleton extends Skeleton<Command>
    {
        ...
        CommandSkeleton(Integer i)
        {
            super(Command.class, TestStorageServer.this, new InetSocketAddress(8021 + 2 * i));
        }
