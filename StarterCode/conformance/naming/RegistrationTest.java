...
public class RegistrationTest extends NamingTest
{
    ...
    public RegistrationTest()
    {
        ...
        System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
        server1 = new TestStorageServer(this, 1);
        server2 = new TestStorageServer(this, 2);
        server3 = new TestStorageServer(this, 3);
        server4 = new TestStorageServer(this, 4);
        badServer = new UnsuccessfulStorageServer(5);
    }
    ...
    private class UnsuccessfulStorageServer extends TestStorageServer
    {
        ...
        UnsuccessfulStorageServer(Integer i)
        {
            super(RegistrationTest.this, i);
        }
        ...
        synchronized void testNullPointers() throws TestFailed
        {
            ...
            try
            {
                ...
                System.out.println("iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii");
                System.out.println(registration_stub.toString());
